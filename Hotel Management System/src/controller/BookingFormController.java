...
public class BookingFormController {
    ...
    public void onAddBooking(MouseEvent mouseEvent) throws SQLException, ClassNotFoundException {
        ...
        String id=cmbRoomId.getSelectionModel().getSelectedItem();
        if (new BookingController().addBookingDetails(b,id)){
    ...
    public void guestDetailsOnAction(ActionEvent actionEvent) throws SQLException, ClassNotFoundException {
        ...
        Guest g1 = new GuestController().getGuest(guestId);
        if (g1==null){
    ...
    private void setRoomData(String roomId) throws SQLException, ClassNotFoundException {
       Room r1 = new RoomController().getRooms(roomId);
        if (r1 == null) {
            ...
            txtRoomName.setText(r1.getRoomName());
            txtRoomType.setText(r1.getRoomType());
            txtCost.setText(String.valueOf(r1.getPrice()));
        }
    }

    public void onModifyBooking(MouseEvent mouseEvent) throws SQLException, ClassNotFoundException {
        LocalDate date=datePickerOut.getValue();
        BookingDetails b=new BookingDetails(
    ...
    public void onDeleteBooking(MouseEvent mouseEvent) {
        try {
            String id = tblBookingDetails.getSelectionModel().getSelectedItem().getBookingId();
            boolean isDelete;
